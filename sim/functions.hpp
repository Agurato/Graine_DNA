...
std::map<std::string, Strand*> AddMutation(DNA mutatedDNA, int mutationPlace, MutationTypes mutationType);
std::map<std::string, Strand*> DelMutation(DNA mutatedDNA, int mutationPlace, MutationTypes mutationType);
...
void saveCsv(std::vector<std::string> saveLines, std::string filename);
